...
class NdsrvpWarpPerspectiveInvoker : public ParallelLoopBody {
public:
    NdsrvpWarpPerspectiveInvoker(const Mat& _src, Mat& _dst, const double* _M, int _interpolation,
    ...
    const double M[9], int interpolation, int borderType, const double borderValue[4])
{
    ...
    NdsrvpWarpPerspectiveInvoker invoker(src, dst, M, interpolation, borderType, Scalar(borderValue[0], borderValue[1], borderValue[2], borderValue[3]));
